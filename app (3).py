...
Original file is located at
    https://colab.research.google.com/drive/1ZbujxN-zCzRwZLXW08f7av7dMNafN9gC
...
age = st.slider('ag', min_value=18, max_value=50, value=20, step=1)
...
data['Tree']=labelencoder.inverse_transform(Y_fut) #es para categoria labelencoder
data.head()
